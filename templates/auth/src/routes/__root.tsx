...
function RootDocument({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body>
        {/*
          Provider chain (see docs/auth-architecture.md for details):
          1. AuthKitProvider (inside ConvexAuthProvider) — WorkOS auth context
          2. ConvexProviderWithAuth (inside ConvexAuthProvider) — Convex + JWT bridge
          3. Your app routes render here as {children}
        */}
